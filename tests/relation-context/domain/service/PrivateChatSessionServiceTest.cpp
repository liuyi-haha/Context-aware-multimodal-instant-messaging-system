...
protected:
    ...
    testing::StrictMock<tests::common::mock::MockFriendShipRepository> mockFriendShipRepository;
    // 领域服务
...
TEST_F(PrivateChatSessionServiceTest, 当当前用户没有任何单聊会话时_调用getPrivateChatSessions_应该返回一个空列表)
{
    ...
    const auto sessions = privateChatSessionService->getPrivateChatSessions();
