...
TEST_F(RelationApplicationServiceTest, 同意好友申请时_如果好友申请状态为Accepted_应该给出提示)
{
...
TEST_F(RelationApplicationServiceTest, 同意好友申请时_如果好友申请状态为Rejected_应该给出提示)
{
...
TEST_F(RelationApplicationServiceTest, 同意好友申请时_如果处理好友申请的用户不是目标用户_应该给出提示)
{
