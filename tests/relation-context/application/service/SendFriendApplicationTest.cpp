...
TEST_F(RelationApplicationServiceTest, 发送好友申请时_如果验证消息长度不合法_应该给出提示)
{
...
TEST_F(RelationApplicationServiceTest, 发送好友申请时_如果对方备注长度不合法_应该给出提示)
{
    auto request = buildValidSendFriendApplicationRequest();
...
TEST_F(RelationApplicationServiceTest, 发送好友申请时_如果存在发送给目标用户且状态为Pending状态的好友申请时_应该给出提示)
{
...
TEST_F(RelationApplicationServiceTest, 发送好友申请时_如果当前用户和目标用户已经是好友_应该给出提示)
{
...
TEST_F(RelationApplicationServiceTest, 发送好友申请时_如果当前用户和目标用户是同一个人_应该给出提示)
{
    auto request = buildValidSendFriendApplicationRequest();
...
TEST_F(RelationApplicationServiceTest, 发送好友申请时_如果一切合法_应该成功得到好友申请ID并在本地仓储新增一条待处理的好友申请记录)
{
