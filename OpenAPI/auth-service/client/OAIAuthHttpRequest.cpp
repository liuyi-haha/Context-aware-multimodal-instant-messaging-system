...
OAIAuthHttpRequestInput::OAIAuthHttpRequestInput() {
    initialize();
}

OAIAuthHttpRequestInput::OAIAuthHttpRequestInput(QString v_url_str, QString v_http_method) {
    initialize();
    url_str = v_url_str;
    http_method = v_http_method;
}

void OAIAuthHttpRequestInput::initialize() {
    var_layout = NOT_SET;
    url_str = "";
    http_method = "GET";
}

void OAIAuthHttpRequestInput::add_var(QString key, QString value) {
    vars[key] = value;
}

void OAIAuthHttpRequestInput::add_file(QString variable_name, QString local_filename, QString request_filename, QString mime_type) {
    OAIAuthHttpFileElement file;
...
OAIAuthHttpRequestWorker::OAIAuthHttpRequestWorker(QObject *parent, QNetworkAccessManager *_manager)
...
OAIAuthHttpRequestWorker::~OAIAuthHttpRequestWorker() {
...
QMap<QString, QString> OAIAuthHttpRequestWorker::getResponseHeaders() const {
    return headers;
}

OAIAuthHttpFileElement OAIAuthHttpRequestWorker::getHttpFileElement(const QString &fieldname) {
    if (!files.isEmpty()) {
    ...
    return OAIAuthHttpFileElement();
}

QByteArray *OAIAuthHttpRequestWorker::getMultiPartField(const QString &fieldname) {
...
void OAIAuthHttpRequestWorker::setTimeOut(int timeOutMs) {
...
void OAIAuthHttpRequestWorker::setWorkingDirectory(const QString &path) {
    if (!path.isEmpty()) {
        workingDirectory = path;
    }
}

void OAIAuthHttpRequestWorker::setResponseCompressionEnabled(bool enable) {
    isResponseCompressionEnabled = enable;
}

void OAIAuthHttpRequestWorker::setRequestCompressionEnabled(bool enable) {
    isRequestCompressionEnabled = enable;
}

int  OAIAuthHttpRequestWorker::getHttpResponseCode() const{
    return httpResponseCode;
}

QString OAIAuthHttpRequestWorker::http_attribute_encode(QString attribute_name, QString input) {
...
void OAIAuthHttpRequestWorker::execute(OAIAuthHttpRequestInput *input) {
    ...
    if (input->var_layout == ADDRESS || input->var_layout == URL_ENCODED) {
        ...
        // add files
        for (QList<OAIAuthHttpFileElement>::iterator file_info = input->files.begin(); file_info != input->files.end(); file_info++) {
    ...
    if (input->request_body.size() > 0) {
        ...
        if(!isFormData && (input->var_layout != MULTIPART) && isRequestCompressionEnabled){
            request_content.append(compress(input->request_body, 7, OAIAuthCompressionType::Gzip));
        } else {
    ...
    if (OAIAuthHttpRequestWorker::sslDefaultConfiguration != nullptr) {
        request.setSslConfiguration(*OAIAuthHttpRequestWorker::sslDefaultConfiguration);
    }
...
void OAIAuthHttpRequestWorker::on_reply_finished(QNetworkReply *reply) {
    bool codeSts = false;
...
void OAIAuthHttpRequestWorker::on_reply_timeout(QNetworkReply *reply) {
...
void OAIAuthHttpRequestWorker::process_response(QNetworkReply *reply) {
    ...
    if (!contentDispositionHdr.isEmpty()) {
        ...
        if ((contentDisposition.count() > 0) && (contentDisposition.first() == QString("attachment"))) {
            ...
            OAIAuthHttpFileElement felement;
...
QByteArray OAIAuthHttpRequestWorker::decompress(const QByteArray& data){
    
    Q_UNUSED(data);
    return QByteArray();
}

QByteArray OAIAuthHttpRequestWorker::compress(const QByteArray& input, int level, OAIAuthCompressionType compressType) {
...
QSslConfiguration *OAIAuthHttpRequestWorker::sslDefaultConfiguration;
