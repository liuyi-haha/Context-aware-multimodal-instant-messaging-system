...
class OAIAuthSerializerSettings {
public:
    ...
    static OAIAuthSerializerSettings *getInstance(){
        if(instance == nullptr){
            instance = new OAIAuthSerializerSettings();
        }
        return instance;
    }

private:
    explicit OAIAuthSerializerSettings(){
        instance = this;
        customDateTimeFormat.isStringSet = false;
        customDateTimeFormat.isEnumSet = false;
    }
    static OAIAuthSerializerSettings *instance;
    CustomDateTimeFormat customDateTimeFormat;
};

OAIAuthSerializerSettings * OAIAuthSerializerSettings::instance = nullptr;
...
bool setDateTimeFormat(const QString &dateTimeFormat){
    ...
    if (dt.isValid()) {
        success = true;
        OAIAuthSerializerSettings::setDateTimeFormatString(dateTimeFormat);
    }
    return success;
}
...
bool setDateTimeFormat(const Qt::DateFormat &dateTimeFormat){
    ...
    if (dt.isValid()) {
        success = true;
        OAIAuthSerializerSettings::setDateTimeFormatEnum(dateTimeFormat);
    }
    return success;
}
...
QString toStringValue(const QDateTime &value) {
    if (OAIAuthSerializerSettings::getInstance()->getCustomDateTimeFormat().isStringSet) {
        return value.toString(OAIAuthSerializerSettings::getInstance()->getCustomDateTimeFormat().formatString);
    }

    if (OAIAuthSerializerSettings::getInstance()->getCustomDateTimeFormat().isEnumSet) {
        return value.toString(OAIAuthSerializerSettings::getInstance()->getCustomDateTimeFormat().formatEnum);
    }
...
QString toStringValue(const OAIAuthObject &value) {
    return value.asJson();
}

QString toStringValue(const OAIAuthEnum &value) {
    return value.asJson();
}

QString toStringValue(const OAIAuthHttpFileElement &value) {
    return value.asJson();
}
...
QJsonValue toJsonValue(const QDateTime &value) {
    if (OAIAuthSerializerSettings::getInstance()->getCustomDateTimeFormat().isStringSet) {
        return QJsonValue(value.toString(OAIAuthSerializerSettings::getInstance()->getCustomDateTimeFormat().formatString));
    }

    if (OAIAuthSerializerSettings::getInstance()->getCustomDateTimeFormat().isEnumSet) {
        return QJsonValue(value.toString(OAIAuthSerializerSettings::getInstance()->getCustomDateTimeFormat().formatEnum));
    }
...
QJsonValue toJsonValue(const OAIAuthObject &value) {
    return value.asJsonObject();
}

QJsonValue toJsonValue(const OAIAuthEnum &value) {
    return value.asJsonValue();
}

QJsonValue toJsonValue(const OAIAuthHttpFileElement &value) {
    return value.asJsonValue();
}
...
bool fromStringValue(const QString &inStr, QDateTime &value) {
    if (inStr.isEmpty()) {
       ...
       QDateTime dateTime;
        if (OAIAuthSerializerSettings::getInstance()->getCustomDateTimeFormat().isStringSet) {
            dateTime = QDateTime::fromString(inStr, OAIAuthSerializerSettings::getInstance()->getCustomDateTimeFormat().formatString);
        } else if (OAIAuthSerializerSettings::getInstance()->getCustomDateTimeFormat().isEnumSet) {
            dateTime = QDateTime::fromString(inStr, OAIAuthSerializerSettings::getInstance()->getCustomDateTimeFormat().formatEnum);
        } else {
...
bool fromStringValue(const QString &inStr, OAIAuthObject &value)
{
    QJsonParseError err;
...
bool fromStringValue(const QString &inStr, OAIAuthEnum &value) {
    value.fromJson(inStr);
    return true;
}

bool fromStringValue(const QString &inStr, OAIAuthHttpFileElement &value) {
...
bool fromJsonValue(QDateTime &value, const QJsonValue &jval) {
    ...
    if (!jval.isUndefined() && !jval.isNull() && jval.isString()) {
        if (OAIAuthSerializerSettings::getInstance()->getCustomDateTimeFormat().isStringSet) {
            value = QDateTime::fromString(jval.toString(), OAIAuthSerializerSettings::getInstance()->getCustomDateTimeFormat().formatString);
        } else if (OAIAuthSerializerSettings::getInstance()->getCustomDateTimeFormat().isEnumSet) {
            value = QDateTime::fromString(jval.toString(), OAIAuthSerializerSettings::getInstance()->getCustomDateTimeFormat().formatEnum);
        } else {
...
bool fromJsonValue(OAIAuthObject &value, const QJsonValue &jval) {
    bool ok = true;
    if (jval.isObject()) {
...
bool fromJsonValue(OAIAuthEnum &value, const QJsonValue &jval) {
    value.fromJsonValue(jval);
    return true;
}

bool fromJsonValue(OAIAuthHttpFileElement &value, const QJsonValue &jval) {
