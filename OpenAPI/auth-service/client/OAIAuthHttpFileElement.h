...
#ifndef OAIAuth_HTTP_FILE_ELEMENT_H
#define OAIAuth_HTTP_FILE_ELEMENT_H
...
Q_DECLARE_METATYPE(OpenAPIAuth::OAIAuthHttpFileElement)

#endif // OAIAuth_HTTP_FILE_ELEMENT_H
