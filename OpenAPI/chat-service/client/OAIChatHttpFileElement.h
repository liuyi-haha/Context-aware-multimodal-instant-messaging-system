...
#ifndef OAIChat_HTTP_FILE_ELEMENT_H
#define OAIChat_HTTP_FILE_ELEMENT_H
...
Q_DECLARE_METATYPE(OpenAPIChat::OAIChatHttpFileElement)

#endif // OAIChat_HTTP_FILE_ELEMENT_H
