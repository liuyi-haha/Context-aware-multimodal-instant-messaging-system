...
#ifndef OAIUser_HTTP_FILE_ELEMENT_H
#define OAIUser_HTTP_FILE_ELEMENT_H
...
Q_DECLARE_METATYPE(OpenAPIUser::OAIUserHttpFileElement)

#endif // OAIUser_HTTP_FILE_ELEMENT_H
