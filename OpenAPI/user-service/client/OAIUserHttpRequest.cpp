...
OAIUserHttpRequestInput::OAIUserHttpRequestInput() {
    initialize();
}

OAIUserHttpRequestInput::OAIUserHttpRequestInput(QString v_url_str, QString v_http_method) {
    initialize();
    url_str = v_url_str;
    http_method = v_http_method;
}

void OAIUserHttpRequestInput::initialize() {
    var_layout = NOT_SET;
    url_str = "";
    http_method = "GET";
}

void OAIUserHttpRequestInput::add_var(QString key, QString value) {
    vars[key] = value;
}

void OAIUserHttpRequestInput::add_file(QString variable_name, QString local_filename, QString request_filename, QString mime_type) {
    OAIUserHttpFileElement file;
...
OAIUserHttpRequestWorker::OAIUserHttpRequestWorker(QObject *parent, QNetworkAccessManager *_manager)
...
OAIUserHttpRequestWorker::~OAIUserHttpRequestWorker() {
...
QMap<QString, QString> OAIUserHttpRequestWorker::getResponseHeaders() const {
    return headers;
}

OAIUserHttpFileElement OAIUserHttpRequestWorker::getHttpFileElement(const QString &fieldname) {
    if (!files.isEmpty()) {
    ...
    return OAIUserHttpFileElement();
}

QByteArray *OAIUserHttpRequestWorker::getMultiPartField(const QString &fieldname) {
...
void OAIUserHttpRequestWorker::setTimeOut(int timeOutMs) {
...
void OAIUserHttpRequestWorker::setWorkingDirectory(const QString &path) {
    if (!path.isEmpty()) {
        workingDirectory = path;
    }
}

void OAIUserHttpRequestWorker::setResponseCompressionEnabled(bool enable) {
    isResponseCompressionEnabled = enable;
}

void OAIUserHttpRequestWorker::setRequestCompressionEnabled(bool enable) {
    isRequestCompressionEnabled = enable;
}

int  OAIUserHttpRequestWorker::getHttpResponseCode() const{
    return httpResponseCode;
}

QString OAIUserHttpRequestWorker::http_attribute_encode(QString attribute_name, QString input) {
...
void OAIUserHttpRequestWorker::execute(OAIUserHttpRequestInput *input) {
    ...
    if (input->var_layout == ADDRESS || input->var_layout == URL_ENCODED) {
        ...
        // add files
        for (QList<OAIUserHttpFileElement>::iterator file_info = input->files.begin(); file_info != input->files.end(); file_info++) {
    ...
    if (input->request_body.size() > 0) {
        ...
        if(!isFormData && (input->var_layout != MULTIPART) && isRequestCompressionEnabled){
            request_content.append(compress(input->request_body, 7, OAIUserCompressionType::Gzip));
        } else {
    ...
    if (OAIUserHttpRequestWorker::sslDefaultConfiguration != nullptr) {
        request.setSslConfiguration(*OAIUserHttpRequestWorker::sslDefaultConfiguration);
    }
...
void OAIUserHttpRequestWorker::on_reply_finished(QNetworkReply *reply) {
    bool codeSts = false;
...
void OAIUserHttpRequestWorker::on_reply_timeout(QNetworkReply *reply) {
...
void OAIUserHttpRequestWorker::process_response(QNetworkReply *reply) {
    ...
    if (!contentDispositionHdr.isEmpty()) {
        ...
        if ((contentDisposition.count() > 0) && (contentDisposition.first() == QString("attachment"))) {
            ...
            OAIUserHttpFileElement felement;
...
QByteArray OAIUserHttpRequestWorker::decompress(const QByteArray& data){
    
    Q_UNUSED(data);
    return QByteArray();
}

QByteArray OAIUserHttpRequestWorker::compress(const QByteArray& input, int level, OAIUserCompressionType compressType) {
...
QSslConfiguration *OAIUserHttpRequestWorker::sslDefaultConfiguration;
