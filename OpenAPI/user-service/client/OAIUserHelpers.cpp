...
class OAIUserSerializerSettings {
public:
    ...
    static OAIUserSerializerSettings *getInstance(){
        if(instance == nullptr){
            instance = new OAIUserSerializerSettings();
        }
        return instance;
    }

private:
    explicit OAIUserSerializerSettings(){
        instance = this;
        customDateTimeFormat.isStringSet = false;
        customDateTimeFormat.isEnumSet = false;
    }
    static OAIUserSerializerSettings *instance;
    CustomDateTimeFormat customDateTimeFormat;
};

OAIUserSerializerSettings * OAIUserSerializerSettings::instance = nullptr;
...
bool setDateTimeFormat(const QString &dateTimeFormat){
    ...
    if (dt.isValid()) {
        success = true;
        OAIUserSerializerSettings::setDateTimeFormatString(dateTimeFormat);
    }
    return success;
}
...
bool setDateTimeFormat(const Qt::DateFormat &dateTimeFormat){
    ...
    if (dt.isValid()) {
        success = true;
        OAIUserSerializerSettings::setDateTimeFormatEnum(dateTimeFormat);
    }
    return success;
}
...
QString toStringValue(const QDateTime &value) {
    if (OAIUserSerializerSettings::getInstance()->getCustomDateTimeFormat().isStringSet) {
        return value.toString(OAIUserSerializerSettings::getInstance()->getCustomDateTimeFormat().formatString);
    }

    if (OAIUserSerializerSettings::getInstance()->getCustomDateTimeFormat().isEnumSet) {
        return value.toString(OAIUserSerializerSettings::getInstance()->getCustomDateTimeFormat().formatEnum);
    }
...
QString toStringValue(const OAIUserObject &value) {
    return value.asJson();
}

QString toStringValue(const OAIUserEnum &value) {
    return value.asJson();
}

QString toStringValue(const OAIUserHttpFileElement &value) {
    return value.asJson();
}
...
QJsonValue toJsonValue(const QDateTime &value) {
    if (OAIUserSerializerSettings::getInstance()->getCustomDateTimeFormat().isStringSet) {
        return QJsonValue(value.toString(OAIUserSerializerSettings::getInstance()->getCustomDateTimeFormat().formatString));
    }

    if (OAIUserSerializerSettings::getInstance()->getCustomDateTimeFormat().isEnumSet) {
        return QJsonValue(value.toString(OAIUserSerializerSettings::getInstance()->getCustomDateTimeFormat().formatEnum));
    }
...
QJsonValue toJsonValue(const OAIUserObject &value) {
    return value.asJsonObject();
}

QJsonValue toJsonValue(const OAIUserEnum &value) {
    return value.asJsonValue();
}

QJsonValue toJsonValue(const OAIUserHttpFileElement &value) {
    return value.asJsonValue();
}
...
bool fromStringValue(const QString &inStr, QDateTime &value) {
    if (inStr.isEmpty()) {
       ...
       QDateTime dateTime;
        if (OAIUserSerializerSettings::getInstance()->getCustomDateTimeFormat().isStringSet) {
            dateTime = QDateTime::fromString(inStr, OAIUserSerializerSettings::getInstance()->getCustomDateTimeFormat().formatString);
        } else if (OAIUserSerializerSettings::getInstance()->getCustomDateTimeFormat().isEnumSet) {
            dateTime = QDateTime::fromString(inStr, OAIUserSerializerSettings::getInstance()->getCustomDateTimeFormat().formatEnum);
        } else {
...
bool fromStringValue(const QString &inStr, OAIUserObject &value)
{
    QJsonParseError err;
...
bool fromStringValue(const QString &inStr, OAIUserEnum &value) {
    value.fromJson(inStr);
    return true;
}

bool fromStringValue(const QString &inStr, OAIUserHttpFileElement &value) {
...
bool fromJsonValue(QDateTime &value, const QJsonValue &jval) {
    ...
    if (!jval.isUndefined() && !jval.isNull() && jval.isString()) {
        if (OAIUserSerializerSettings::getInstance()->getCustomDateTimeFormat().isStringSet) {
            value = QDateTime::fromString(jval.toString(), OAIUserSerializerSettings::getInstance()->getCustomDateTimeFormat().formatString);
        } else if (OAIUserSerializerSettings::getInstance()->getCustomDateTimeFormat().isEnumSet) {
            value = QDateTime::fromString(jval.toString(), OAIUserSerializerSettings::getInstance()->getCustomDateTimeFormat().formatEnum);
        } else {
...
bool fromJsonValue(OAIUserObject &value, const QJsonValue &jval) {
    bool ok = true;
    if (jval.isObject()) {
...
bool fromJsonValue(OAIUserEnum &value, const QJsonValue &jval) {
    value.fromJsonValue(jval);
    return true;
}

bool fromJsonValue(OAIUserHttpFileElement &value, const QJsonValue &jval) {
